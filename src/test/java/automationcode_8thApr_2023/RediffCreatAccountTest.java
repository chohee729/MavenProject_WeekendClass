package automationcode_8thApr_2023;
...
public class RediffCreatAccountTest {
	...
	public void rediffCreateAccount() {
		...
		AssertJUnit.assertTrue(actualAvailabilityMessage.contains(expectedAvailabilityMessage));
		...
		AssertJUnit.assertTrue(actualUnregisteredWarningMessage.contains(expectedUnregisteredWarninngMessage));
